...
and tonight we want to show you how you can use the web to do an audio / visual live performance.
...
(add detail pics or drawings of the parts)
...
(open *NerdDrum Demo & enable Websocket connection*)
...
**TIM:** Sam and I met through Live:JS, a collective of audio and visual artists who *build live experiences, shows and installations*, a couple of months ago.  

**SAM:** I travelled to Germany to meet Tim in person, and we combined our projects in a hack weekend. (*PICTURE*)

**SAM:** But tonight, in this sweet venue, in Paris, we're going to rock this conference.
...
* finalize nerdV
* Tell what we combined and how
* Which parts of NERDDISCO are now inside modV?
